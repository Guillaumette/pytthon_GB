...
if __name__ == "__main__":
    ...
    json_filename = input("Введите имя файла для сохранения результатов в формате JSON: ")
    save_results_to_json(results, json_filename)

    csv_filename = input("Введите имя файла для сохранения результатов в формате CSV: ")
    save_results_to_csv(results, csv_filename)

    pickle_filename = input("Введите имя файла для сохранения результатов в формате Pickle: ")
    save_results_to_pickle(results, pickle_filename)

    print("Результаты сохранены в форматах JSON, CSV и Pickle.")
